...
public final class TestText {
    ...
    //sou//////////////////////////////////////////////////////////////////////////////////
    @Test
    public void testTextWithDateFormatBlankArg() {
        TimeZone userTZ = LocaleUtil.getUserTimeZone();
        LocaleUtil.setUserTimeZone(TimeZone.getTimeZone("CET"));
        try {
            // Test with Java style M=Month
            ValueEval blankArg = BlankEval.instance;
            ValueEval formatArg = new StringEval("YYYYMM");
            ValueEval[] args = { blankArg, formatArg };
            ValueEval result = TextFunction.TEXT.evaluate(args, -1, (short)-1);
            ValueEval testResult = new StringEval("189912");
            assertEquals(testResult.toString(), result.toString());
